...
class Ctrl_Node:
    ...
    def __init__(self):
        ...
        self._my_pid_state_pub = rospy.Publisher(
        ...
        self._my_pid_effort_sub = rospy.Subscriber(
            "/control_effort", Float64, self._effortCallback)
        self._my_path_publisher = rospy.Publisher(
            "/create1/my_path", Path, queue_size=10)
        self._my_path = Path()

        self._my_pid_setpoint_pub = rospy.Publisher(
...
# Create a callback function for the subscriber.
    ...
    def _callback(self, data):
        ...
        self._my_pid_state = self._diff_angle()
        self._my_pid_setpoint.data = 0.0
        self._my_pid_setpoint_pub.publish(self._my_pid_setpoint)
